...
- `article.html` и страницы статей `*.html` - SEO-раздел со 102 статьями для продвижения услуг в Туле.
...
- добавляются 6 общих статей по ремонту техники, диагностике, срочному ремонту, выбору мастера, ценам, срокам и профилактике;
- итог: `article.html` и 102 детальные страницы статей;
- каждая статья получает `title`, `description`, `keywords`, `h1`, Open Graph, Article schema и перелинковку на услугу.
- на детальной странице услуги выводятся 6 тематических статей по этой услуге.
